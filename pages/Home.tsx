  ...
  return (
    <PageTransition className="relative">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 px-4 overflow-hidden">
        ...
        {/* Premium CSS Animated Background - Keeping static relative to transition to avoid flicker */}
        ...
        <div className="max-w-5xl mx-auto text-center z-10 relative">
          <motion.div>
            ...
            <motion.h1 
              variants={itemVariants}
              className="text-6xl md:text-8xl font-display font-bold text-white mb-8 leading-tight tracking-tight drop-shadow-2xl"
            >
              Constructing <br />
            ...
            <motion.p 
              variants={itemVariants}
              className="text-muted-light text-lg md:text-xl max-w-2xl mx-auto mb-12 leading-relaxed font-light"
            >
      ...
      {/* Animated Text Strip */}
      <motion.div variants={itemVariants} className="w-full bg-neon-cyan/5 border-y border-neon-cyan/10 py-8 overflow-hidden backdrop-blur-sm">
